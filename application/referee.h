...
typedef struct //比赛机器人状态：0x0201。发送频率：10Hz，发送范围：单一机器人。
{
  ...
  uint16_t shooter_id1_17mm_speed_limit;    //机器人1号17mm枪口每秒冷却值
			
	uint16_t shooter_id2_17mm_cooling_rate;    //机器人2号17mm枪口每秒冷却值
  uint16_t shooter_id2_17mm_cooling_limit;   //机器人2号17mm枪口热量上限
  uint16_t shooter_id2_17mm_speed_limit;    //机器人2号17mm枪口每秒冷却值
			
	uint16_t shooter_id1_42mm_cooling_rate;   //机器人1号42mm枪口每秒冷却值
  uint16_t shooter_id1_42mm_cooling_limit;  //机器人1号42mm枪口热量上限
  uint16_t shooter_id1_42mm_speed_limit;    //机器人1号42mm枪口每秒冷却值
	uint16_t max_chassis_power;              //机器人最大底盘功率， 单位 w
...
{ 
    ...
    uint16_t bullet_remaining_num_17mm; //子弹剩余发射数目
...
typedef struct 
{
	...
	uint32_t  sentry_gun_count;				//哨兵成功兑换的发弹量值
	uint32_t  sentry_gun_exchange_count;   //哨兵成功远程兑换发弹量的次数
	uint32_t  sentry_hp_exchange_count;    //哨兵成功远程兑换血量的次数
